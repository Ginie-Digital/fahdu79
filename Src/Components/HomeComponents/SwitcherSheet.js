...
const SwitcherSheet = ({}) => {
  ...
  const createPostBottomSheetVisibility = useSelector(
    state => state.hideShow.visibility.switchBottomSheet,
  );
      ...
      <BottomSheetModal
        ...
        <View style={styles.contentContainer}>
          <View style={styles.createPostListContainer}>
            <TouchableOpacity
              style={[styles.eachlist, {marginTop: responsiveWidth(1)}]}
              onPress={() => handleSwitchApp('Social')}>
