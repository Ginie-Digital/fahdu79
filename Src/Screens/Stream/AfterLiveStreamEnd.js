...
const AfterLiveStreamEnd = ({route}) => {
  ...
  useEffect(() => {
    let difference =
      new Date(route?.params?.data?.endTime) -
      new Date(route?.params?.data?.startTime);
            ...
            <View
              ...
              <View style={[styles.card, {elevation: 0}]}>
                <View style={styles.cardLeftView}>
                  ...
                  <View
                    style={[
                      styles.eachDetailWrapper,
                      {backgroundColor: '#FFA86B', marginBottom: 0},
                    ]}>
