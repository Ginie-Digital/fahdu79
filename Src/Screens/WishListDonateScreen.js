        ...
        <View style={styles.dialog}>
          ...
          <View style={styles.headerRow}>
            <TouchableOpacity onPress={handleClose} style={styles.backButton}>
              <DIcon provider={'AntDesign'} name={'arrowleft'} color={'#000'} size={responsiveFontSize(3)} />
            </TouchableOpacity>
            <Text style={styles.sendTipText}>Raise Fund</Text>
          ...
          <ScrollView contentContainerStyle={styles.contentContainer} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.tipContainer}>
              <View style={styles.tipCounterContainer}>
                <View style={styles.sendTipInputContainer}>
                  ...
                  <View style={styles.rightAction}>
                    <TouchableOpacity style={styles.plusMinusButton} onPress={decrementAmount}>
                      <View style={[styles.plusMinusButtonInside, {backgroundColor: '#ff6961'}]}>
                        <DIcon provider={'Entypo'} name={'minus'} size={18} />
                      </View>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.plusMinusButton} onPress={incrementAmount}>
              ...
              <View style={styles.buttonWrapper}>
                <AnimatedButton title={'Pay'} onPress={handleSubmitMoney} loading={loading} />
              </View>
            </View>
